...
function handleAttempt(data) {
    ...
    if (skipped || Exercises.assessmentMode) {
        ...
        //ZZZ STOPSHIP start
        $("#solutionarea").append("<style type='text/css'> label {float:left;padding: 0;text-align: center;}</style>");
        $("#solutionarea").append("<p>How difficult would you rate this problem, on a scale of 1 to 5?</p>");
        $("#solutionarea").append("<label for='secondQ1'>Not at all<br><input type='radio' id ='secondQ1' name='secondQ' value='1'> </label>");
        $("#solutionarea").append("<label for='secondQ2'>2<br><input type='radio' id ='secondQ2' name='secondQ' value='1'> </label>");
        $("#solutionarea").append("<label for='secondQ3'>3<br><input type='radio' id ='secondQ3' name='secondQ' value='1'> </label>");
        $("#solutionarea").append("<label for='secondQ4'>4<br><input type='radio' id ='secondQ4' name='secondQ' value='1'> </label>");
        $("#solutionarea").append("<label for='secondQ5'>Very difficult<br><input type='radio' id ='secondQ5' name='secondQ' value='1'> </label>");
        //ZZZ STOPSHIP end
    } else {
